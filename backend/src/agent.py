...
def seed_database():
    ...
    if cur.fetchone()[0] == 0:
        sample_data = [('Michael', '44521', '3344', 'Mega Electronics Co.', '$799.99', '2025-11-21 13:47:22 EST', 'megastore.com', 'confirmed_safe', 'User confirmed the transaction of $799.99 at Mega Electronics Co. was legitimate.'),
  ('Priya', '77003', '5566', 'LuxuryFashions Ltd.', '$1,250.00', '2025-11-22 09:05:10 GMT', 'luxfashions.com', 'confirmed_fraud', 'User confirmed transaction was fraudulent. Initiated card block.'),
  ('Ravi', '22334', '7788', 'Global Travel Agency', '$3,499.50', '2025-11-23 22:30:45 PST', 'globaltravel.com', 'pending_review', 'Automated flag: Unusual travel-booking transaction.'),
  ('John', '12345', '4242', 'ABC Industry', '$450.00', '2:30 AM EST', 'alibaba.com', 'pending_review', 'Automated flag: High value transaction.'),
  ('Sarah', '99887', '1199', 'Unknown Crypto Exchange', '$2,100.00', '4:15 AM PST', 'online_transfer', 'pending_review', 'Automated flag: Unusual location.'),
  ('Aisha', '88990', '9900', 'Online Gaming Zone', '$299.99', '2025-11-24 18:12:55 EST', 'gamingzone.net', 'pending_review', 'Automated flag: Suspicious merchant category.'),
  ('David', '55667', '1122', 'Furniture World', '$540.75', '2025-11-25 11:20:30 GMT', 'furnitureworld.com', 'pending_review', 'Automated flag: Large furniture purchase.'),
  ('Neha', '33445', '2233', 'Digital Books Store', '$45.99', '2025-11-26 07:45:00 PST', 'ebooks-online.com', 'pending_review', 'Automated flag: Frequent small-value purchases.'),
  ('Arjun', '66778', '3345', 'Sports Gear Hub', '$149.49', '2025-11-26 15:30:20 EST', 'sportshub.com', 'pending_review', 'Automated flag: New merchant unfamiliar.'),
  ('Meena', '11223', '4455', 'Health Supplements Inc.', '$89.00', '2025-11-27 08:10:05 GMT', 'healthsupps.store', 'pending_review', 'Automated flag: Unusual purchase pattern.'),
  ('Raj', '99001', '6677', 'Electronics MegaStore', '$2,999.99', '2025-11-27 20:55:50 PST', 'electromega.com', 'pending_review', 'Automated flag: High-value electronics purchase.')]
        cur.executemany(
            """
