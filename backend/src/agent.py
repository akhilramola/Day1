...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - KREMLIN CAFFE")
print("📚 WELCOME TO KREMLIN CAFFE")
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "Kremlin Caffe".
...
async def entrypoint(ctx: JobContext):
    ...
    print("\n" + "🏪" * 25)
    print("🚀 KREMLIN CAFFE - AI BARISTA")
    print("👨‍⚕️ Sponsered by uncle sam")
    print("📺 ")
